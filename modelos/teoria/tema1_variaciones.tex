...
Primeramente definimos un tipo de funciones llamadas \textit{funciones test} o \textit{funciones de la clase de Swartz}, junto con algunos resultados que usaremos bastante para trabajar con ellas.
...
\begin{lemma}
Sean $f$,$g$ funciones continuas en $(a,b)$ tales que:

\[
\integral{}{}{g\phi}+\integral{}{}{f\phi'}=0 \espacio \forall\phi\in\soportecompacto
\]

Entonces $f\in C^1(a,b)$ y $g=f'$.
\end{lemma}

\begin{proof}
Tomamos $x_0\in(a,b)$ y definimos $\tilde{f}(x)=\integral{a}{x}{g(s)ds}\Rightarrow \tilde{f}\in C^1$.
...
A continuación veremos un ejemplo teórico y algunos ejemplos más prácticas de la teoría anterior.
