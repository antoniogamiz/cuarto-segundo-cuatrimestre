...
\right.
\]
donde $R(x)$ es un cierto polinomio que no nos interesa calcular. Queremos ver que $\limite{x}{0^-}{g^{n)}(x)}=0$, con lo cual, $g\in C^n$. Haciendo el cambio $y=-\frac{1}{x}$, el anterior límite equivale a 
\[
