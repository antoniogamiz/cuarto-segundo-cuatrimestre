...
\[
\tilde{f}(x)-\tilde{f}(y)=\integral{x}{y}{g(s)ds} \Rightarrow |f(x)|\leq|f(y)|+\norm{g}_{L^1}
\]
...
\[
(b-a)|f(x)|\leq \norm{\tilde{f}}_{L^2}(b-a)^{1/2}+\norm{g}_{L^2}(b-a)^{3/2} \Rightarrow
\]
\[
|f(x)|\leq c_1\norm{f}_{L^2}+c_2\norm{g}_{L^2} \Rightarrow
\]
\[
\norm{\tilde{f}}_\infty\leq c_1\norm{f}_{L^2}+c_2\norm{g}_{L^2} \leq (c_1+c_2)\normasobolev{1}{f}
\]
\end{proof}
...
\begin{figure}[h]
   \center
  \includegraphics[width=100mm]{img/puenteflotante.png}
\end{figure}
